...
describe("Challenge07", () => {
  test("CV-Formatter", () => {
    ...
    expect(JSON.stringify(cvFormatter(first_Cv_Sample))).toBe(JSON.stringify(received));
    expect(JSON.stringify(cvFormatter(second_Cv_Sample))).toBe(JSON.stringify(received2));
  });
});
